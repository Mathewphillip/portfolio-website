...
return(
    <div className="relative h-screen bg-dark text-accent">
          <Navbar/>
          <motion.section
        className="bg-dark text-white pt-16 sm:py-12 h-100vh relative flex flex-col justify-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
         <motion.h1
            className="text-2xl sm:text-3xl font-bold text-secondary py-4 mt-16 text-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
